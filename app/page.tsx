...
export default function Home() {
  ...
  const [appState, setAppState] = useState<
    "idle" | "selecting" | "dropping" | "result"
  >("idle");
          ...
          {selectedMonth && (
            <>
              ...
              <Button
                onClick={handleDrop}
                disabled={isDropping}
                className={`w-full py-6 text-xl bg-red-600 hover:bg-red-700 text-white pricedown-font rounded-full shadow-lg transition-all ${
